...
from app.models import WizardStep, MediaServer
...
class TestServeWizardFunction:
    ...
    def test_serve_wizard_with_pre_phase(self, app, client, sample_wizard_steps, sample_media_server):
        """Test _serve_wizard() with pre phase."""
        from app.blueprints.wizard.routes import _serve_wizard, _steps, _settings
    ...
    def test_serve_wizard_with_post_phase(self, app, client, sample_wizard_steps, sample_media_server):
    ...
    def test_serve_wizard_full_page_rendering(self, app, client, sample_wizard_steps, sample_media_server):
    ...
    def test_serve_wizard_htmx_partial_rendering(self, app, client, sample_wizard_steps, sample_media_server):
        ...
        with app.app_context():
            with client:
                ...
                with client.application.test_request_context(headers={"HX-Request": "true"}):
                    response = _serve_wizard("plex", 0, steps, phase="pre")
    ...
    def test_serve_wizard_interaction_requirement_detection(self, app, client, sample_wizard_steps, sample_media_server):
    ...
    def test_serve_wizard_phase_parameter_passed_to_template(self, app, client, sample_wizard_steps, sample_media_server):
    ...
    def test_serve_wizard_clamps_index_to_valid_range(self, app, client, sample_wizard_steps, sample_media_server):
...
class TestLegacyServeFunction:
    ...
    def test_legacy_serve_delegates_to_serve_wizard(self, app, client, sample_wizard_steps, sample_media_server):
    ...
    def test_legacy_serve_uses_post_invite_category(self, app, client, sample_wizard_steps, sample_media_server):
